...
#define NL_CONSTRAST 0.88   // 0.3 low ~ 2.0 high
#define NL_EXPOSURE 1.456   // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.263 // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
#define NL_MIST_DENSITY 1.7      // 0.0 no mist ~ 1.0 misty
...
#define NL_NIGHT_ZENITH_COL  vec3(0.00,0.29,0.63)
#define NL_NIGHT_HORIZON_COL vec3(0.00,0.39,0.84)
...
#define NL_DAWN_HORIZON_COL  vec3(0.9,0.3,0.3)*0.9
#define NL_DAWN_EDGE_COL     vec3(1.0,0.4,0.2)*0.8

/* Rainbow */
//#define NL_RAINBOW         // [toggle] enable rainbow in sky
#define NL_RAINBOW_CLEAR 0.3 // 0.3 subtle ~ 1.7 bright during clear
...
/* Water */
#define NL_WATER_TRANSPARENCY 0.21 // 0.0 transparent ~ 1.0 normal
...
#define NL_AURORA_COL1 vec3(0.0,1.0,0.56)
#define NL_AURORA_COL2 vec3(1.0,0.30,0.84)
...
#define NL_GODRAY 0.47 // [toggle] 0.1 subtle ~ 0.8 strong
